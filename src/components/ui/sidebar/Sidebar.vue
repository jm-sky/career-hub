...
<template>
  ...
  >
    ...
    >
      <div
        data-sidebar="sidebar"
        class="glass-surface flex h-full w-full flex-col border-r border-sidebar-border bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-none"
      >
        <slot />
      </div>
    </div>
