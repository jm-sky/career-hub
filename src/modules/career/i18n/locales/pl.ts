  ...
  career: {
    ...
    cvVersions: {
      page: {
        ...
        generateStub: 'Generowanie PDF nie jest jeszcze zaimplementowane — żądanie zostało przyjęte, ale plik nie zostanie utworzony.',
        downloadStub: 'Dla tej wersji CV nie wygenerowano jeszcze pliku PDF.',
      },
      form: {
