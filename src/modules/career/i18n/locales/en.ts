  ...
  career: {
    ...
    cvVersions: {
      page: {
        ...
        generateStub: 'PDF generation is not implemented yet — this request was accepted but no file will be produced.',
        downloadStub: 'No PDF has been generated for this CV version yet.',
      },
      form: {
