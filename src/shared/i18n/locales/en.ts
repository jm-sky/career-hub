...
export default {
  ...
  privacy: {
    ...
    dataCollection: {
      ...
      description: 'CareerHub application collects the following data:',
      items: {
        account: 'Account data: email, full name (required to create an account)',
        gear: 'Career profile data: experience, projects, skills, education, certifications (stored in database)',
  ...
  terms: {
    ...
    acceptance: {
      ...
      description: 'By using the CareerHub application, you accept these terms of use. If you do not agree with any of the following terms, you should not use the service.',
    },
    account: {
      title: 'User Account',
  ...
  landing: {
    title: 'CareerHub',
    subtitle: 'One professional profile. As many tailored CVs as you need.',
    welcomeBack: 'Welcome back, {name}!',
    feature1: {
      title: 'Build',
      description: 'Capture your experience, projects, and skills once',
    },
    feature2: {
      title: 'Curate',
      description: 'Select what matters for each application',
    },
    feature3: {
      title: 'Share',
      description: 'Generate a tailored CV or share your public profile link',
    },
    login: 'Log In',
    register: 'Sign Up',
    footer: 'Start building your profile today',
  },
  notFound: {
  ...
  about: {
    ...
    subtitle: 'A single professional profile that generates as many tailored CVs as you need',
    tableOfContents: {
      title: 'Table of Contents',
    },
    overview: {
      title: 'Overview',
      description: 'CareerHub is a full-stack application for building one master professional profile — experience, projects, skills, education, certifications — and generating multiple tailored CVs from it. It combines an intuitive front-end interface with a robust backend to keep your career data in sync across devices.',
    },
    capabilities: {
      title: 'Key Capabilities',
      multiUser: 'Multi-User Platform - Secure user accounts with authentication and authorization',
      hybrid: 'Freemium Tiers - Free, Pro, and Expert plans gate CV limits, watermarking, AI features, and custom domain',
      organization: 'Curated CVs - Named CV versions select which experiences, projects, skills, and education to include',
      metadata: 'Rich Metadata - Track responsibilities, technologies, anonymized clients, achievements, and certifications',
      portability: 'Data Portability - LinkedIn import, copy-paste import fallback, and full JSON export',
    },
    coreFeatures: {
      title: 'Core Features',
      containers: {
        title: 'Profile',
        multiple: 'Multi-step profile wizard with per-step draft autosave',
        hierarchical: 'Completeness score to nudge you toward a fuller profile',
        colors: 'Three-level visibility - Private, Friends, or Public',
        metadata: 'Public profile page at a shareable slug, SEO-friendly',
        cycle: 'Contact info, headline, summary, and profile photo',
      },
      items: {
        title: 'Experience & Projects',
        rich: 'Rich per-role data: company, position, employment type, dates, responsibilities, technologies',
        categorization: 'Projects documented independently of roles, then explicitly linked to one or more experiences and skills',
        status: 'Anonymization - hide the real company/client name behind a placeholder for NDA-restricted work',
        priority: 'User-orderable sections via drag-and-drop',
        expiration: 'Track achievements, challenges, and scale (team size, duration, users, budget)',
      },
      analytics: {
        title: 'Skills',
        weight: 'Categorized skills (Technical/Tools/Soft) with 1-5 proficiency level and years of experience',
        readiness: 'Linkable to specific projects to show where a skill was applied',
        charts: 'AI-suggested skills for a target role (Pro/Expert)',
        statistics: 'A shared technology catalog reused across profiles',
      },
      search: {
        title: 'CV Generation',
        smart: 'Multiple named CV versions per profile, each a curated selection over the master profile',
        filtering: 'Optional custom summary override per CV version',
        sorting: 'Template choice per CV version',
        expired: 'Asynchronous PDF generation as a background job; Free tier PDFs are watermarked',
      },
      importExport: {
        title: 'Import/Export',
        json: 'Full JSON export/import of your profile data',
        markdown: 'LinkedIn import as a background job',
        csv: 'Copy-paste text fallback parser when a LinkedIn export is unavailable',
        crossDevice: 'Cross-device access - your profile is stored server-side, not just on one device',
      },
    },
    businessFeatures: {
      ...
      security: {
        ...
        oauth: 'OAuth social login - sign in with Google, Facebook, or GitHub',
  ...
  aiContext: {
    title: 'AI Context',
    subtitle: 'Short description of CareerHub in Markdown format for AI assistants like ChatGPT',
    card: {
      title: 'Copy Context to Clipboard',
      description: 'Click the button below to copy the context description. You can then paste it into ChatGPT or other AI assistants to provide context about CareerHub.',
    },
