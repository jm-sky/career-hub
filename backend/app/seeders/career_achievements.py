...
RAW_ACHIEVEMENTS: list[dict] = [
    {
        ...
        "description": ("Promoted to lead the programming team at Skłodowscy Sp. z o.o., owning delivery " "of portals, ERP/MES integrations, and internal AI tooling."),
        "date": "2021-11-01",
        "category": "OTHER",
        "url": None,
    },
    {
        ...
        "description": ("Started shipping SaaS products, client websites, and full-stack tools under the " "DEV Made IT personal brand (Gear Stack, Company Hub, SaasBase, CareerHub, and more)."),
        "date": "2025-04-01",
        "category": "OTHER",
    ...
    },
    {
        ...
        "description": ("Led architecture and delivery of a client portal used by hundreds of users, " "integrating ERP data, documents, and later KSeF e-invoicing."),
        "date": "2018-01-01",
        "category": "OTHER",
    ...
    },
    {
        ...
        "description": ("Designed and led development of a custom manufacturing execution system with " "RFID/barcode workflows, service tracking, and time & attendance."),
        "date": "2016-02-01",
        "category": "OTHER",
        "url": None,
    },
